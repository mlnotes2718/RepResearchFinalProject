...
### Handle Mispell
```{r}
wrongType <- c("ASTRONOMICAL HIGH TIDE", "AVALANCE", "APACHE COUNTY")
correctType <- c("ASTRONOMICAL LOW TIDE", "AVALANCHE", "THUNDERSTORM WIND")
reducedStormData$EVTYPE <- gsub(wrongType, correctType, reducedStormData$EVTYPE)
```
